...
\begin{itemize}
\item
The insertion of the package \verb:beamer-rl: with \verb:\usepackage{beamer-rl}:  must always be done before the declaration of the theme
\item
...
\item
In some cases you  need to use \verb:\babelsublr: command from \verb:bebel: package to insert a left to right text within your right to left text, or you can use the \hologo{LuaTeX} command
\verb:\textdir TLT: to change direction of text     
\end{itemize}
